...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Admin/DataBarang">
                    <i class="fas fa-fw fa-mobile"></i>
                    <span>Data Barang</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Admin/Contact">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Data Contact</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Admin/User">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Data User</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Admin/UserAdmin">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Data User Admin</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Admin/Transaksi">
                    <i class="fas fa-fw fa-user"></i>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Data Contact</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlahcontact;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Data User Admin</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlahuseradmin;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlahdatatransaksi;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
