...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Produk/index">
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="<?= base_url().'/public/img2/' . $dtl["gambar"];?>" height="200px;" width="200px">
                                </div>
                                <div class="col-md-8">
                                    <table class="table">
                                        <tr>
                                            <td>Nama Produk</td>
                                            <td><strong><?= $dtl["nama_barang"];?></strong></td>
                                        </tr>
                                        <tr>
                                            <td>Keterangan</td>
                                        ...
                                        <tr>
                                            <td>Harga Produk</td>
                                            <td><strong>Rp. <?= number_format($dtl["harga"], 0,',','.') ;?></strong></td>
                                        </tr>
                                        <tr>
                                            <td>Berat Produk</td>
                                            <td><strong><?= $dtl["berat"];?>gr</strong></td>
                                        </tr>
                                        <tr>
                                            <td>Stok Produk</td>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <form action="<?= base_url()?>Halaman_Produk/keranjang/<?= $dtl["id"]?>" method="post">
    ...
    <script>
        gsap.from(".card", { duration: 2, x: -100, opacity: 0 });
    </script>
</body>
