...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Produk Berhasil</strong> <?= $this->session->flashdata("flash")?> Ke Keranjang.
                ...
                <div class="container conn-1">
                    <div class="row row-container me-4 ms-4">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                            <div class="card card-1 mt-3">
                                <img src="<?= base_url().'/public/img2/'. $prdk["gambar"]?>"/>
                                <div class="card-body text-center">
                                    <h5 class="card-title"><?= $prdk["nama_barang"];?></h5>
                                    <small><?= $prdk["kategori"]?></small>
                                    <span class="badge badge-pill badge-success mt-3">Rp. <?= number_format($prdk["harga"], 0, ',','.');?></span>
                                    <!-- <a href="<?= base_url()?>Halaman_Produk/keranjang/<?= $prdk["id"];?>" class="btn btn-sm btn-primary d-grid">Tambah Ke Keranjang</a> -->
                                    <a href="<?= base_url()?>Halaman_Produk/Detail/<?= $prdk["id"];?>" class="btn btn-sm btn-dark mt-3 d-grid">Lihat Produk</a>
                                </div>
                            </div>
                        </div>
                        <?php endforeach;?>
    ...
    <script>
        gsap.from(".card-1", { duration: 3, rotateY: 360, opacity: 0 });
    </script>
