        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container mb-5">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h5 class="ms-5 p-2 text-center mb-5 databarang" style="font-size: 25px; font-weight:700">DATA BARANG</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h5 class="ms-5 p-2 mb-4">Total Data Keseluruhan Barang : <?= $totalbarang;?></h5>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table">
                        ...
                        <?php foreach($barang as $brg):?>
                            ...
                            <td class="d-flex justify-content-center">
                                <a href="<?= base_url()?>Halaman_Admin/HapusBarang/<?= $brg["id"];?>" onclick="return confirm('Yakin')" class="badge badge-danger">Hapus</a>
                                <a href="<?= base_url()?>Halaman_Admin/DetailBarang/<?= $brg["id"];?>" class="badge badge-orange">Detail</a>
                            </td>
                            </tr>
                        </tbody>
                        <?php $i++;?>
