    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- About -->
                <div class="container">
                    <h5 class="card-header text-center mb-4 p-3" style="font-size: 25px;">Detail Histori Pembelian</h5>
                </div>
                    ...
                    <div class="row" style="background-color: white; padding:2px; margin:2px">
                        <div class="col-12">
                            <table class="table mt-3 ms-auto">
                                ...
                                <?php $no = 1;?>
                                <?php foreach ($detailhistori as $detail): ?>
                            
                                <tr>
                                    <td><?= $detail["id_barang"];?></td>
                                    <td><?= $no++;?></td>
                                    <td><?= $detail["nama_barang"]?></td>
                                    <td style="text-align:left">Rp. <?php echo number_format($detail["harga"], 0, ',', '.'); ?></td>
                                    <td style="text-align: center;"><?= $detail["berat_satuan_produk"];?>gr</td>
                                    <td><?= $detail["qty"];?></td>
                                    <td style="text-align:left">Rp. <?php echo number_format($detail["total"], 0, ',', '.'); ?></td>
                                    <td style="text-align:left">Rp. <?php echo number_format($detail["subtotal"], 0, ',', '.'); ?></td>
                                </tr>
