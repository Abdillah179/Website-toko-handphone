        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container mb-5">
                    <?php if($this->session->flashdata("gagal")):?>
                        <div class="alert alert-warning alert-dismissible fade show col-9" role="alert">
                            Upload Foto <strong><?= $this->session->flashdata("gagal")?></strong> 
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php endif;?>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h5 class="ms-5 p-2 text-center mb-5 databarang" style="font-size: 25px; font-weight:700">DATA TRANSAKSI</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h5 class="ms-5 p-2 mb-4">Total Data Keseluruhan : <?= $totaltransaksi;?></h5>
                        </div>
                    </div>
                </div>
                ...
                <!-- <div class="container">
                    <div class="row">
                        <div class="col">
                            <a href="<?= base_url()?>Halaman_Admin/TambahData"><button type="button" class="btn btn-primary">Tambah Data Barang</button></a>
                        </div>
                    </div>
                </div> -->
                ...
                <div class="col-lg">
                    <table class="table">
                        <thead>
                            ...
                            <th scope="col">Provinsi Pembeli</th>
                        ...
                        <?php foreach($user as $usr):?>
                            <tr>
                            <th scope="row"><?= $i;?></th>
                            <td><?= $usr["nama_pembeli"];?></td>
                            <td><?= $usr["no_hp_pembeli"];?></td>
                            <td><?= $usr["provinsi"];?></td>
                            <td class="d-flex justify-content-center">
                                <a href="<?= base_url()?>Halaman_Admin/HapusTransaksi/<?= $usr["id"];?>" onclick="return confirm('Yakin')" class="badge badge-danger">Hapus</a>
                                <a href="<?= base_url()?>Halaman_Admin/DetailTransaksi/<?= $usr["id"];?>" class="badge badge-orange">Detail</a>
                            </td>
                            </tr>
                        </tbody>
                        <?php $i++;?>
