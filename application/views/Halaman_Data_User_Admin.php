            ...
            <div class="container mb-5">
                    <?php if($this->session->flashdata("admin")):?>
                        <div class="alert alert-warning alert-dismissible fade show col-9" role="alert">
                            Data <strong><?= $this->session->flashdata("admin");?></strong> 
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php endif;?>
                </div>
            ...
            <div class="container">
                <div class="col-lg">
                    <table class="table">
                        ...
                        <tbody>
                        <?php $i = 1;?>
                        <?php foreach($useradmin as $usradm):?>
                            <tr>
                            <th scope="row"><?= $i;?></th>
                            <td><?= $usradm["username"];?></td>
                            <td class="d-flex justify-content-center">
                                <a href="<?= base_url()?>Halaman_Admin/HapusUserAdmin/<?= $usradm["id"];?>" onclick="return confirm('Yakin')" class="badge badge-danger">Hapus</a>
                                <a href="<?= base_url()?>Halaman_Admin/DetailUserAdmin/<?= $usradm['id'];?>" class="badge badge-orange">Detail</a>
                            </td>
                            </tr>
                        </tbody>
                        <?php $i++;?>
