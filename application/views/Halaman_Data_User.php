                    ...
                    <table class="table">
                        ...
                        <?php foreach($user as $usr):?>
                            ...
                            <td class="d-flex justify-content-center">
                                <a href="<?= base_url()?>Halaman_Admin/HapusUser/<?= $usr["id"];?>" onclick="return confirm('Yakin')" class="badge badge-danger">Hapus</a>
                                <a href="<?= base_url()?>Halaman_Admin/DetailUser/<?= $usr['id'];?>" class="badge badge-orange">Detail</a>
                            </td>
                            </tr>
                        </tbody>
                        <?php $i++;?>
