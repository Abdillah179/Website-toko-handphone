    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- About -->
                <div class="container">
                    <h5 class="card-header text-center mb-4 p-3" style="font-size: 25px;">Detail Lengkap Transaksi</h5>
                </div>
                    ...
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background-color: white;">
                            <table class="table" style="font-size: 17px;">
                                <tr>
                                 <span class="badge bg-white" style="font-size: 20px;">Id Invoice: <?= $trsk["id"];?></span>
                                </tr>
                                <tr>
                                    <td>Tanggal Pembelian : </td>
                                    <td><?= $trsk["tanggal_pemesanan"];?></td>
                                </tr>
                                <tr>
                                    <td>Nama Pembeli :</td>
                                ...
                                <tr>
                                    ...
                                    <td><?= $trsk["jasa_pengiriman"];?></td>
                                </tr>
                                <tr>
                                    <td>Pembayaran :</td>
                                    <td><?= $trsk["pembayaran"];?></td>
                                </tr>
                                <tr>
                                    <td>Alamat Lengkap :</td>
                                    <td><?= $trsk["alamat_lengkap_tujuan"];?></td>
                                </tr>
                            </table>
                        </ol>
                    </nav>
                        ...
                        <div class="col-12">
                            <table class="table mt-3 ms-auto">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left">Rp. <?php echo number_format($psn["harga"], 0, ',', '.'); ?></td>
                                    <td style="text-align: center;"><?= $psn["berat_satuan_produk"];?>gr</td>
                                    <td><?= $psn["qty"];?></td>
                                    <td style="text-align:left">Rp. <?php echo number_format($psn["total"], 0, ',', '.'); ?></td>
                                    <td style="text-align:left">Rp. <?php echo number_format($psn["subtotal"], 0, ',', '.'); ?></td>
                                </tr>
