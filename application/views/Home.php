...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_About/index">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Gallery/index">
                    <i class="fas fa-images"></i>
                    <span>Gallery</span></a>
            </li> -->

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Contact/Contact">
                    <i class="fas fa-phone"></i>
                    <span>Contact</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>Halaman_Produk/Histori">
                    <i class="fas fa-shopping-cart"></i>
                    <span>Histori Struk Pembelian</span></a>
            </li>
                ...
                <?php if($this->session->userdata("session")):?>
                    <div class="container">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            Login Berhasil </strong>Selamat Datang <strong><?= $session["username"];?></strong> 
