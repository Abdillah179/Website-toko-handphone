...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container mb-5">
                    <?php if($this->session->flashdata("tidakberhasil")):?>
                        <div class="alert alert-warning alert-dismissible fade show col-9" role="alert">
                            Data<strong><?= $this->session->flashdata("tidakberhasil")?>Ditambahkan</strong> 
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php endif;?>
                </div>
                ...
                <div class="container mb-5">
                    <?php if($this->session->flashdata("sukses")):?>
                        <div class="alert alert-warning alert-dismissible fade show col-9" role="alert">
                            Data <strong><?= $this->session->flashdata("sukses")?>Ditambahkan</strong> 
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php endif;?>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h5 class="ms-5 p-2 text-center mb-5 databarang" style="font-size: 25px; font-weight:700">FORM TAMBAH DATA BARANG</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url()?>Halaman_Admin/TambahData" method="post" enctype="multipart/form-data">
                                        <div class="form-group mb-5">
                                            <small class="form-text text-danger"><?= form_error("nama_barang");?></small>
                                            <label for="nama" class="form-label">NAMA BARANG</label>
                                            <input type="text" class="form-control" name= "nama_barang" id="nama" placeholder="Masukkan Nama Barang">
                                        </div>
                                        <div class="form-group mb-5">
                                            <small class="form-text text-danger"><?= form_error("keterangan");?></small>
                                            <label for="keterangan" class="form-label">KETERANGAN BARANG</label>
                                            <textarea class="form-control" id="keterangan" name= "keterangan" rows="3" placeholder="Masukkan Keterangan Barang"></textarea>
                                        </div>
                                        <div class="form-group mb-5">
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="text" class="form-control" name="gambar" id="gambar" placeholder="Masukkan Gambar Barang">
                                        </div>
