            ...
            <div class="container mb-5">
                    <?php if($this->session->flashdata("contact")):?>
                        <div class="alert alert-warning alert-dismissible fade show col-9" role="alert">
                            Data Berhasil <strong><?= $this->session->flashdata("contact")?></strong> 
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php endif;?>
                </div>
            ...
            <div class="container">
                <div class="col-lg">
                    <table class="table">
                        ...
                        <tbody>
                        <?php $i = 1;?>
                        <?php foreach($contact as $cnct):?>
                            <tr>
                            <th scope="row"><?= $i;?></th>
                            <td><?= $cnct["nama"];?></td>
                            <td><?= $cnct["email"];?></td>
                            <td class="d-flex justify-content-center">
                                <a href="<?= base_url()?>Halaman_Admin/HapusContact/<?= $cnct['id'];?>" onclick="return confirm('Yakin Ingin Menghapus ???')" class="badge badge-danger">Hapus</a>
                                <a href="<?= base_url()?>Halaman_Admin/DetailContact/<?= $cnct["id"];?>" class="badge badge-orange">Detail</a>
                            </td>
                            </tr>
                        </tbody>
                        <?php $i++;?>
