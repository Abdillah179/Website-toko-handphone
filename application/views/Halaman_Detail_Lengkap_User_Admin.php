            ...
            <div class="container">
                <div class="col-lg">
                    <table class="table">
                        ...
                        <tbody>
                        <?php $i = 1;?>
                        <?php foreach($detailuseradmin as $dtlusradm):?>
                            <tr>
                            <th scope="row"><?= $i;?></th>
                            <td><?= $dtlusradm["username"];?></td>
                            <td><?= $dtlusradm["password"];?></td>
                            <td><?= $dtlusradm["role_id"];?></td>
                            <td><?= $dtlusradm["is_active"];?></td>
                            <td><?= $dtlusradm["date_created"];?></td>
                            </tr>
                        </tbody>
                        <?php $i++;?>
                        <?php endforeach;?>
