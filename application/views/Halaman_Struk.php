    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- About -->
                <?php foreach($struk as $hstr):?>
                <div class="container">
                    <?php if($this->session->flashdata("bayar")):?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        Produk <strong><?= $this->session->flashdata("bayar")?></strong> Di Pesan. Barang Anda Akan Kami Proses Dan Akan Kami Kirimkan Secepatnya. <a href="<?= base_url()?>Halaman_Produk/DetailHistori/<?= $hstr["id"]?>">Klik Disini Untuk Melihat Struk Pembayaran Anda</a>
